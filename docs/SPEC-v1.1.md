...
## Context & Goal
Implement the core visual identity defined in SPEC v1.0. This issue establishes the radical Black & White aesthetic, ensuring high-contrast readability for both web and laser printing (HP LaserJet).
